...
namespace San2 {
	...
	{
		class RegisterEphemeralIn : public San2::Rpc::CIRpcSyncFunctionIn
		{
		public:
			static const int timeoutMilisec;
		
			RegisterEphemeralIn(San2::Node::CPortmap& portmapper, San2::Utils::CProducerConsumer<std::shared_ptr<San2::Network::CCapsule> > &applicationQueue); // must be mutexed inside portmapper!!!
