...
namespace DragonSRP
{
	...
	{
		if (calc_M1.size() == 0) throw DsrpException("SrpVerificator::authenticate: calc_M1.size() == 0");
		if (M1_from_client.size() == 0) throw DsrpException("SrpVerificator::authenticate: M1_from_client.size() == 0");
